      ...
      */}
      <div>
        ...
        <div className="md:pl-64 flex flex-col flex-1">
          <div className="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-gray-600 shadow">
            <button
              type="button"
              ...
              <div className="flex-1 flex">
                <form className="w-full flex md:ml-0" action="#" method="GET">
                  ...
                  <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                    ...
                    <input
                      id="search-field"
                      className="block bg-gray-600 w-full h-full pl-8 pr-3 py-2 border-transparent text-gray-100 placeholder-gray-200 focus:outline-none focus:placeholder-gray-400 focus:ring-0 focus:border-transparent sm:text-sm"
                      placeholder="Search"
                      type="search"
                      name="search"
                    />
